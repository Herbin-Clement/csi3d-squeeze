...
class Decimater(obja.Model):
    ...
    def load_graph(self, filename):
        ...
        self.graph = objToGraphe.create_graph(self.vertices, self.faces)

    def get_graph(self):
        return self.graph

    def compress_model(self, output):
        compressed = False
        operations = []
    ...
    def step_compression(self):
        ...
        for edge in edges:
            ...
            for w in neighbors:
                if w != v1 and w != v2 and not utils.is_valid_triangle(v1, v2, w, self.graph, self.faces):
                    valid = False
                    break
